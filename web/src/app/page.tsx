      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5 max-w-3xl w-full" style={{ animation: "slideUp 0.6s ease 0.1s forwards", opacity: 0 }}>
        <Link href="/combo-builder" className="block group">
          <div className="glass-card p-7 cursor-pointer">
            ...
            <h2 className="text-base font-semibold mb-1.5" style={{ color: "var(--foreground)" }}>{t("home.combo.title")}</h2>
            <p className="text-xs leading-relaxed mb-4" style={{ color: "var(--muted)" }}>{t("home.combo.desc")}</p>
            <span className="text-[10px] font-semibold px-2.5 py-1 rounded-full uppercase tracking-wider" style={{ background: "var(--accent-glow)", color: "var(--accent)" }}>{t("home.combo.available")}</span>
          </div>
        </Link>
        ...
        <div className="glass-card p-7 opacity-30 cursor-not-allowed">
          ...
          <h2 className="text-base font-semibold mb-1.5">{t("home.stitch.title")}</h2>
          <p className="text-xs leading-relaxed mb-4" style={{ color: "var(--muted)" }}>{t("home.stitch.desc")}</p>
          <span className="text-[10px] font-medium px-2.5 py-1 rounded-full" style={{ background: "var(--surface)", color: "var(--muted)" }}>{t("home.coming_soon")}</span>
        </div>
        ...
        <div className="glass-card p-7 opacity-30 cursor-not-allowed">
          ...
          <h2 className="text-base font-semibold mb-1.5">{t("home.batch.title")}</h2>
